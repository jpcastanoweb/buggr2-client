...
export default function SubscribePage() {
  ...
  return (
    <div className="h-screen flex flex-col">
      <div className="h-18 bg-green-400">
        <div className="max-w-7xl mx-auto py-3 px-3 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between flex-wrap">
            <div className="w-0 flex-1 flex items-center">
              <span className="flex p-2 rounded-lg bg-purple-900">
      ...
      <div className="flex-grow bg-white flex md:justify-center sm:justify-center">
        ...
        <div className="bg-white text-black">
          <div className="flex flex-row justify-between mt-5 px-5">
            <button
              className="flex flex-row gap-5  text-black hover:text-gray-400"
              onClick={() => {
                signout();
              }}
            >
          ...
          <div className="max-w-xl mx-auto pt-5 pb-10 px-4 sm:px-6 lg:px-8">
            <div className="sm:flex sm:flex-col sm:align-center">
              <h1 className="mt-5 text-4xl font-extrabold text-gray-900 sm:text-center">
                Activate Your Account
              </h1>
              <p className="mt-5 text-md text-gray-500 sm:text-center">
                Start managing your team's projects and pay monthly or yearly.
              </p>
            </div>
            <div className="mt-4 space-y-4 xs:flex xs:flex-column sm:mt-8 sm:space-y-0 sm:gap-10 lg:max-w-xl lg:mx-auto xl:max-w-none xl:mx-0 ">
              <div className="border border-gray-200 mb-5 rounded-lg shadow-sm divide-y divide-gray-200">
                <div className="p-6">
                  ...
                  <button
                    className="mt-4 block w-full bg-gray-800 border border-gray-800 rounded-md py-2 text-sm font-semibold text-white text-center hover:bg-gray-900"
                    type="reset"
                    onClick={(e) => {
